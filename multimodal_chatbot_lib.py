...
def convert_chat_messages_to_messages_api(chat_messages):
    print("checking chat_history ", chat_messages)
    messages = []
    
    for chat_msg in chat_messages:
        if (chat_msg.message_type == 'image'):
            print("checking chat_msg ", chat_msg.message_type)
            messages.append({
                "role": "user",
                "content": [
                    {
...
def chat_with_model(message_history, new_text=None, new_image_bytes=None):
    ...
    if new_text:
        ...
        print("checking new_text_message ", new_text_message)
        ...
        print("checking new_image_message ",new_image_message)
